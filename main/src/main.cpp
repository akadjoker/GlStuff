...
int main()
{
    ...
    Mesh* plane = MeshManager::Instance().CreatePlane(5.0f, 5.0f,16,16, 5, 5);
    Mesh* sphere = MeshManager::Instance().CreateSphere(1.0f, 16, 16);
    Mesh* cylinder = MeshManager::Instance().CreateCylinder(1.0f, 2.0f, 16);
    Mesh* gizmoX = MeshManager::Instance().CreateGizmoAxis(1.0f, 0.2f, Vec3(1.0f, 0.0f, 0.0f));
    Mesh* gizmoY = MeshManager::Instance().CreateGizmoAxis(1.0f, 0.2f, Vec3(0.0f, 1.0f, 0.0f));
    Mesh* gizmoZ = MeshManager::Instance().CreateGizmoAxis(1.0f, 0.2f, Vec3(0.0f, 0.0f, 1.0f));
