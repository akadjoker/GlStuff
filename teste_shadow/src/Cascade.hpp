...
public:
    bool Initialize()
    {
        ...
        for (int i = 0; i < SHADOW_MAP_CASCADE_COUNT; i++)
        {
            ...
            glTexImage2D(GL_TEXTURE_2D, 0, internalFormat, SHADOW_WIDTH, SHADOW_HEIGHT, 0, GL_DEPTH_COMPONENT, type, nullptr);
    ...
    void Bind(int cascadeIndex) const
    {
         
            u32 text= shadowMaps[cascadeIndex];
